...
class ElectionListConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        self.group_name = "election_lobby"
    ...
    # This function receives the signal from models.py and forwards it to the browser
    async def election_update(self, event):
        # We send a simple "trigger" message.
        # The frontend will receive this and re-fetch the clean API data.
